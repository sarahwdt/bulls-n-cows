...
public class EasyDecimalNumberGameControllerBuilder implements GameControllerBuilder {
    ...
    public void setSecretCreator() {
        controller.getGameCore().setSecretCreator(new DecimalNumberSecretCreator(4));
    }
