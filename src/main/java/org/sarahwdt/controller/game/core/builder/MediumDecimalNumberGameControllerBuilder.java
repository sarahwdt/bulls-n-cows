...
public class MediumDecimalNumberGameControllerBuilder implements GameControllerBuilder {
    ...
    public void setSecretCreator() {
        controller.getGameCore().setSecretCreator(new DecimalNumberSecretCreator(6));
    }
    ...
    public BullsAndCowsGameController getController() {
        return controller;
    }
